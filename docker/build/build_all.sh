...
# Uncomment this to enable buildkit - multiarch
#export BUILD_CMD="DOCKER_BUILDKIT=1 docker buildx build"
...
export SKY_TAG_SUFFIX="amd64_tun_v15"
export SCRIPT_DIR

for n in base server s3proxy; do
    ${SCRIPT_DIR}/${n}/build.sh
done
